...
\title{Week 5 Data Visualization Lab}
...
\hypersetup{
  pdftitle={Week 5 Data Visualization Lab},
  pdfauthor={Haroon Riyaz (PID A15377799)},
  hidelinks,
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Week 5 Data Visualization Lab}

\CommentTok{\# Install ggplot2 package }
\CommentTok{\# install.packages("ggplot2")}


\CommentTok{\# *Any time I want to use }
\CommentTok{\# this package I need to load it!*}
\FunctionTok{library}\NormalTok{(ggplot2)}

\CommentTok{\# View Cars data}
\FunctionTok{View}\NormalTok{(cars)}

\CommentTok{\# Plot Cars data (base R plot)}
\FunctionTok{plot}\NormalTok{(cars)}
\end{Highlighting}
\end{Shaded}

\includegraphics{project5_files/figure-latex/unnamed-chunk-1-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# ggplot graph}
...
\includegraphics{project5_files/figure-latex/unnamed-chunk-1-2.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Saves in p}
...
\includegraphics{project5_files/figure-latex/unnamed-chunk-1-3.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Add a trend line close to data}
...
\includegraphics{project5_files/figure-latex/unnamed-chunk-1-4.pdf}
...
\includegraphics{project5_files/figure-latex/unnamed-chunk-1-5.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# *Questions for gene analysis*}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Q. Column names and number of rows?}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Q. How many up regulated genes there are?}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Q. Fraction of genes up{-}regulated (2 SF)}
...
\includegraphics{project5_files/figure-latex/-\#-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Add some color}
\CommentTok{\#g + scale\_color\_manual(values=c("blue","gray","red")) +}
\CommentTok{\#  labs(title = "Gene Expression changes", x="Control (no drug)", y="drug treatment")+}
